...
- Literature review and docs reverted to the verified 5-review / 10-entry basis: the 2026-09-12 TraceGrant/IGAC addendum was removed intentionally; `roadmap.md`, `README.md`, `docs/blueprint.md`, and `references.bib` are consistent again (blueprint typo fix included).
